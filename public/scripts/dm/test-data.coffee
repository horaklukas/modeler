...
#tab0.render canvas.html
#tab1.render canvas.html
#tab2.render canvas.html
#tab3.render canvas.html
#tab4.render canvas.html
#tab5.render canvas.html
...
#canvas.addChild rel1, false
#p = new goog.graphics.Path()
#p.moveTo(50,50).lineTo 300,200
#canvas.drawPath p, new goog.graphics.Stroke(3, '#000'), new goog.graphics.SolidFill('#000') 